...
open class WWCalendarTimeSelector: UIViewController, UITableViewDelegate, UITableViewDataSource, WWCalendarRowProtocol, WWClockProtocol {
    ...
    open var optionCalendarLocale = "es"
    ...
    open func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if tableView == calendarTable {
            if let c = tableView.dequeueReusableCell(withIdentifier: "cell") {
                ...
                calRow.optionCalendarLocale = optionCalendarLocale
...
internal class WWCalendarRow: UIView {
    ...
    internal var optionCalendarLocale : String = ""
        ...
        if detail.type == .month {
          ...
          //  let monthHeight = ceil(monthFont.lineHeight)
            ...
            let usDateFormat = DateFormatter()
                       usDateFormat.dateFormat = "MMMM yyyy"
                       usDateFormat.locale = Locale(identifier: optionCalendarLocale)
                       let monthName = usDateFormat.string(from: startDate).capitalized
...
internal class WWClock: UIView {
    ...
    internal override func draw(_ rect: CGRect) {
        ...
        if showingHour {
            let textAttr : [NSAttributedString.Key : Any] = [.font: fontHour, NSAttributedString.Key.foregroundColor: fontColorHour, NSAttributedString.Key.paragraphStyle: paragraph]
            let textAttrHighlight : [NSAttributedString.Key : Any] = [.font: fontHourHighlight, NSAttributedString.Key.foregroundColor: fontColorHourHighlight, NSAttributedString.Key.paragraphStyle: paragraph]
